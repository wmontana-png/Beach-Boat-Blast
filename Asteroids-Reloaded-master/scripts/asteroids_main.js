...
function onloadHandler()
{
   ...
   g_backgroundImg.src = 'images/Ocean.jpg';
...
(function()
{
   Asteroids.Main = function()
   {
      ...
      loader.addImage(g_playerImg, 'images/TheShip.png');
      loader.addImage(g_asteroidImgs[0], 'images/Beachball.png');
      loader.addImage(g_asteroidImgs[1], 'images/Beachball.png');
      loader.addImage(g_asteroidImgs[2], 'images/Beachball.png');
      loader.addImage(g_asteroidImgs[3], 'images/Beachball.png');
      loader.addImage(g_shieldImg, 'images/shield.png');
      loader.addImage(g_enemyshipImg, 'images/Fish_1.png');
